...
//  Juego: tragamonedas
let tragamonedas:Tragamonedas = new Tragamonedas(50,250);

//  Juego:  tragamonedasBonus
let tragamonedasBonus:TragamonedasBonus = new TragamonedasBonus(50,5);

// Juego: caraSeca
let caraSeca: CaraSeca = new CaraSeca(50,10,"cara");
